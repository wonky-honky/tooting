...
public:
  virtual uint32_t hash() const { return 27; }

  virtual godot::String get_as_text() const { return "<MyCallableCustom>"; }

  static bool
  compare_equal_func(CallableCustom const * inA, CallableCustom const * inB) {
    return inA == inB;
  }
  ...
  static bool
  compare_less_func(CallableCustom const * inA, CallableCustom const * inB) {
    return reinterpret_cast<void const *>(inA)
           < reinterpret_cast<void const *>(inB);
  }
  ...
  virtual godot::ObjectID get_object() const { return godot::ObjectID(); }

  virtual void call(
      godot::Variant const ** inArguments,
      int inArgcount,
      godot::Variant & outReturnValue,
      GDExtensionCallError & outCallError
  ) const {
    UNUSED(inArguments);
    UNUSED(inArgcount);
...
ExampleRef::ExampleRef() {
  ...
  godot::UtilityFunctions::print(
      "ExampleRef ",
      godot::itos(mID),
      " created, current instance count: ",
      godot::itos(sInstanceCount)
  );
}
...
ExampleRef::~ExampleRef() {
  ...
  godot::UtilityFunctions::print(
      "ExampleRef ",
      godot::itos(mID),
      " destroyed, current instance count: ",
      godot::itos(sInstanceCount)
  );
}

void ExampleRef::setId(int inID) { mID = inID; }

int ExampleRef::getID() const { return mID; }

void ExampleRef::_bind_methods() {
  godot::ClassDB::bind_method(
      godot::D_METHOD("set_id", "id"),
      &ExampleRef::setId
  );
  godot::ClassDB::bind_method(godot::D_METHOD("get_id"), &ExampleRef::getID);

  godot::ClassDB::bind_method(
      godot::D_METHOD("was_post_initialized"),
...
godot::String Example::returnSomething(godot::String const & inBase) {
...
ExampleRef * Example::returnExtendedRef() const {
  // You can instance and return a refcounted object like this, but keep in mind
  // that refcounting starts with the returned object and it will be destroyed
  // when all references are destroyed. If you store this pointer you run the
  // risk of having a pointer to a destroyed object.
  return memnew(ExampleRef());
}

godot::Ref<ExampleRef> Example::extendedRefChecks(godot::Ref<ExampleRef> inRef
) const {
  ...
  godot::UtilityFunctions::print(
      "  Example ref checks called with value: ",
      inRef->get_instance_id(),
      ", returning value: ",
      ref->get_instance_id()
  );
...
godot::Variant Example::varargsFunc(
  ...
  godot::UtilityFunctions::print(
      "  Varargs (Variant return) called with ",
      godot::String::num_int64(inArgCount),
      " arguments"
  );
...
int Example::varargsFuncNonVoidReturn(
    godot::Variant const ** inArgs,
    GDExtensionInt inArgCount,
    GDExtensionCallError & outError
) {
  ...
  godot::UtilityFunctions::print(
      "  Varargs (int return) called with ",
      godot::String::num_int64(inArgCount),
      " arguments"
  );
...
void Example::varargsFuncVoidReturn(
    godot::Variant const ** inArgs,
    GDExtensionInt inArgCount,
    GDExtensionCallError & outError
) {
  ...
  godot::UtilityFunctions::print(
      "  Varargs (no return) called with ",
      godot::String::num_int64(inArgCount),
      " arguments"
  );
}

void Example::emitCustomSignal(godot::String const & inName, int inValue) {
  emit_signal("custom_signal", inName, inValue);
}

int Example::defArgs(int inA, int inB) const { return inA + inB; }
...
void Example::testTypedArrayArg(godot::TypedArray<int64_t> const & inArray) {
...
Example * Example::testNodeArgument(Example * inNode) const {
  ...
  godot::UtilityFunctions::print(
      ...
      (inNode != nullptr) ? godot::String::num_int64(
                                static_cast<int64_t>(inNode->get_instance_id())
                            )
                          : "null"
  );
  return inNode;
...
godot::String Example::testStrUtility() const {
  return godot::UtilityFunctions::str(
      "Hello, ",
      "World",
      "! The answer is ",
      42
...
bool Example::testStringIsFortyTwo(godot::String const & inString) const {
...
godot::Vector2i
Example::testVariantVector2iConversion(godot::Variant const & inVariant) const {
  return inVariant;
}

int Example::testVariantIntConversion(godot::Variant const & inVariant) const {
  return inVariant;
}

float Example::testVariantFloatConversion(godot::Variant const & inVariant
) const {
  return inVariant;
}
...
godot::Variant Example::testVariantIterator(godot::Variant const & inVariant) {
  godot::Array output;
  godot::Variant iter;
...
void Example::testAddChild(godot::Node * inNode) { add_child(inNode); }

void Example::testSetTileset(
...
void Example::callableBind() {
  godot::Callable c =
      godot::Callable(this, "emit_custom_signal").bind("bound", 11);
  c.call();
}

void Example::unboundMethod1(
...
godot::String Example::unboundMethod2(
    godot::Object * inObject,
    godot::String inString,
    int inInt
) {
...
godot::String Example::unboundMethod3(
    godot::Object * inObject,
    godot::String inString,
    int inInt
) const {
...
void Example::unboundStaticMethod1(
    Example * inObject,
    godot::String inString,
    int inInt
) {
...
godot::String Example::unboundStaticMethod2(
    godot::Object * inObject,
    godot::String inString,
    int inInt
) {
...
godot::BitField<Example::Flags>
Example::testBitfield(godot::BitField<Flags> inFlags) {
  godot::UtilityFunctions::print(
      "  Got BitField: ",
      godot::String::num_int64(inFlags)
  );
  return inFlags;
}

// RPC
void Example::testRPC(int inValue) { mLastRPCArg = inValue; }

void Example::testSendRPC(int inValue) { rpc("test_rpc", inValue); }

int Example::returnLastRPCArg() { return mLastRPCArg; }

// Properties
void Example::setCustomPosition(godot::Vector2 const & inPos) {
  mCustomPosition = inPos;
}

godot::Vector2 Example::getCustomPosition() const { return mCustomPosition; }

godot::Vector4 Example::getV4() const { return {1.2f, 3.4f, 5.6f, 7.8f}; }
...
// Static methods
int Example::testStatic(int inA, int inB) { return inA + inB; }

void Example::testStatic2() { godot::UtilityFunctions::print("  void static"); }

// Virtual function override.
bool Example::_has_point(godot::Vector2 const & inPoint) const {
...
void Example::_bind_methods() {
  // Methods.
  godot::ClassDB::bind_method(
      godot::D_METHOD("simple_func"),
      &Example::simpleFunc
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("simple_const_func"),
      &Example::simpleConstFunc
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("return_something"),
      &Example::returnSomething
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("return_something_const"),
      &Example::returnSomethingConst
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("return_empty_ref"),
      &Example::returnEmptyRef
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("return_extended_ref"),
      &Example::returnExtendedRef
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("extended_ref_checks", "ref"),
      &Example::extendedRefChecks
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("test_array"),
      &Example::testArray
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_tarray_arg", "array"),
      &Example::testTypedArrayArg
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_tarray"),
      &Example::testTypedArray
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_dictionary"),
      &Example::testDictionary
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_node_argument"),
      &Example::testNodeArgument
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("test_string_ops"),
      &Example::testStringOps
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_str_utility"),
      &Example::testStrUtility
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_string_is_forty_two"),
      &Example::testStringIsFortyTwo
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_string_resize"),
      &Example::testStringResize
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("test_vector_ops"),
      &Example::testVectorOps
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("test_object_cast_to_node", "object"),
      &Example::testObjectCastToNode
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_object_cast_to_control", "object"),
      &Example::testObjectCastToControl
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_object_cast_to_example", "object"),
      &Example::testObjectCastToExample
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("test_variant_vector2i_conversion", "variant"),
      &Example::testVariantVector2iConversion
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_variant_int_conversion", "variant"),
      &Example::testVariantIntConversion
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_variant_float_conversion", "variant"),
      &Example::testVariantFloatConversion
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_variant_call", "variant"),
      &Example::testVariantCall
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_variant_iterator", "input"),
      &Example::testVariantIterator
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("test_add_child", "node"),
      &Example::testAddChild
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_set_tileset", "tilemap", "tileset"),
      &Example::testSetTileset
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("test_callable_mp"),
      &Example::testCallableMP
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_callable_mp_ret"),
      &Example::testCallableMPRet
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_callable_mp_retc"),
      &Example::testCallableMPRetC
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_callable_mp_static"),
      &Example::testCallableMPStatic
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_callable_mp_static_ret"),
      &Example::testCallableMPStaticRet
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_custom_callable"),
      &Example::testCustomCallable
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("test_bitfield", "flags"),
      &Example::testBitfield
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("test_rpc", "value"),
      &Example::testRPC
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_send_rpc", "value"),
      &Example::testSendRPC
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("return_last_rpc_arg"),
      &Example::returnLastRPCArg
  );

  godot::ClassDB::bind_method(
      godot::D_METHOD("def_args", "a", "b"),
      &Example::defArgs,
      DEFVAL(100),
      DEFVAL(200)
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("callable_bind"),
      &Example::callableBind
  );
  godot::ClassDB::bind_method(
      godot::D_METHOD("test_post_initialize"),
      &Example::testPostInitialize
  );

  godot::ClassDB::bind_static_method(
      "Example",
      godot::D_METHOD("test_static", "a", "b"),
      &Example::testStatic
  );
  godot::ClassDB::bind_static_method(
      "Example",
      godot::D_METHOD("test_static2"),
      &Example::testStatic2
  );

  {
    ...
    godot::ClassDB::bind_vararg_method(
        godot::METHOD_FLAGS_DEFAULT,
        "varargs_func",
        &Example::varargsFunc,
        mi
    );
...

  {
    ...
    godot::ClassDB::bind_vararg_method(
        godot::METHOD_FLAGS_DEFAULT,
        "varargs_func_nv",
        &Example::varargsFuncNonVoidReturn,
        mi
    );
  }
  ...
  godot::ClassDB::bind_method(
      godot::D_METHOD("emit_custom_signal", "name", "value"),
...
bool Example::_get(godot::StringName const & inName, godot::Variant & outReturn)
    const {
  godot::String name = inName;
...
void Example::_get_property_list(godot::List<godot::PropertyInfo> * outList
) const {
  outList->push_back(
      godot::PropertyInfo(godot::Variant::VECTOR3, "property_from_list")
  );

  for (int i = 0; i < 3; ++i) {
    outList->push_back(godot::PropertyInfo(
        godot::Variant::VECTOR2,
        "dproperty_" + godot::itos(i)
    ));
  }
}

bool Example::_property_can_revert(godot::StringName const & inName) const {
  if (inName == godot::StringName("property_from_list")
      && mPropertyFromList
             != godot::Vector3(MAGIC_NUMBER, MAGIC_NUMBER, MAGIC_NUMBER)) {
    return true;
  }
...
bool Example::_property_get_revert(
    godot::StringName const & inName,
...
godot::String Example::_to_string() const {
  return "[ GDExtension::Example <--> Instance ID:"
         + godot::uitos(get_instance_id()) + " ]";
}
